          ...
          <div class="form-holder">
            <div class="form-content">
              <div class="form-items">
                <h4 class="text-center text-primary">Edit Data Petugas</h4>
                  ...
                  <div class="wizard-pane">
                    ...
                    <div class="form-group row align-items-center">
                      ...
                      <div class="col-lg-4 col-md-6">
                        <select name="level" class="form-control">
                          <option value="<?php echo $data['level']; ?>" selected disabled><?php echo $data['level']; ?>
                          </option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4 col-md-6 text-right">
                        <button type="submit" class="btn btn-icon icon-right btn-success">UBAH PENGGUNA<i
